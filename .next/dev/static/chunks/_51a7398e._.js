...
function NetPlayer({ video, onBack }) {
    ...
    const handleDeepScan = async ()=>{
        ...
        try {
            ...
            console.error(e);
            alert("Scan failed. Ensure the FFmpeg script is loaded.");
        }
        setIsScanning(false);
    };
    ...
    const handleFFmpegSubtitleSelect = async (track)=>{
        ...
        if (url) {
            ...
            setTimeout(()=>{
                const tracks = Array.from(videoRef.current?.textTracks || []);
                selectTextTrack(tracks.length - 1);
            }, 100);
        } else {
...
_s(NetPlayer, "3gNwcuVJHknwTP14ivQTQS0EXEU=", false, function() {
    return [
...
//# sourceMappingURL=_51a7398e._.js.map